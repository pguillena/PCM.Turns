...
namespace Appointment.Infraestructure.Implementation
{
    public class SQLServer
    {
        ...
        public int InsertOne(string Command, List<SqlParameter> sqlParameterCollection)
        {
            if (sqlConnection == null)
                sqlConnection = new SqlConnection(oSettings.ConnectionString);
            try
        ...
        public List<T> ReadValuesID<T>(string Command, List<SqlParameter> sqlParameterCollection)
        {
            List<T> listValues;
            if (sqlConnection == null)
                sqlConnection = new SqlConnection(oSettings.ConnectionString);
