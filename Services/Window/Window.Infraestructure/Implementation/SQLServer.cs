...
using System.Text;
using Window.Infraestructure;
using System.Data.SqlClient;
using System.Data;

namespace Window.Infraestructure.Implementation
{
    public class SQLServer
    {
        ...
        public SQLServer(string ConnectionString)
        {
            ...
            {
                throw new Exception("No se pudo guardar la información del archivo de configuración.", ex);
            }
        }
        ...
        public int Delete(string Command, List<SqlParameter> sqlParameterCollection)
        {
            if (sqlConnection == null)
                sqlConnection = new SqlConnection(oSettings.ConnectionString);
            try
