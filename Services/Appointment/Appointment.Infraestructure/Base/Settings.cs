...
namespace Appointment.Infraestructure
{
    [Serializable]
    public class Settings
    {
        ...
        public void Load()
        {
            ...
            //ConnectionString = @"data source=LAPTOP-DIT01; initial catalog = db_pcm_gob_pe_turn; User ID=sa; Password=123456";

            //ConnectionString = @"data source=100600-0053\MSSQLSERVER2; initial catalog = db_pcm_gob_pe_turn; persist security info = True; Integrated Security = SSPI";
            ...
            //ConnectionString = "Data Source=192.1; Initial Catalog=db_pcm_gob_pe_turn_v6; User ID=sa; Password=123456";
            return;
        }
